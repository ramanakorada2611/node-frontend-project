...
const [post,setPost]=useState('')
  ...
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/foodLatestPosts').then(response=>response.json())
    .then(json=>setPost(json))
  },[])
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/foodArticles').then(response=>response.json())
    .then(json=>setPost1(json))
  },[])
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/foodPosts').then(response=>response.json())
    .then(json=>setPost2(json))
  },[])
   useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/foodstories').then(response=>response.json())
