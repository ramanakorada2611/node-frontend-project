...
export const Fitness= () => {
  ...
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/fitnessLatestPosts').then(response=>response.json())
    .then(json=>setPost(json))
  },[])
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/fitnessArticles').then(response=>response.json())
    .then(json=>setPost1(json))
  },[])
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/fitnessPosts').then(response=>response.json())
    .then(json=>setPost2(json))
  },[])
   useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/fitnessstories').then(response=>response.json())
