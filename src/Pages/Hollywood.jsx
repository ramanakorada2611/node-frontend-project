...
export const Hollywood = () => {
  ...
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/hollywoodLatestPosts').then(response=>response.json())
    .then(json=>setPost(json))
  },[])
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/hollywoodArticles').then(response=>response.json())
    .then(json=>setPost1(json))
  },[])
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/hollwoodPosts').then(response=>response.json())
    .then(json=>setPost2(json))
  },[])
  // useEffect(()=>{
  //   fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/hollywoodSidePost').then(response=>response.json())
  //   .then(json=>setPost3(json))
  // },[])
  useEffect(()=>{
    fetch('https://node-backend-project-1wnx3825i-ramanakorada2611.vercel.app/hollywoodstories').then(response=>response.json())
    .then(json=>setPost4(json))
  },[])
  return (
    <><Appnavbar/>
...

{
  post1 && post1.map((item)=>{
    return(
      <Cards1 name={item.name} image={item.image} descripiton={item.descripition} date={item.date}/>
    )
  })
} </div>
